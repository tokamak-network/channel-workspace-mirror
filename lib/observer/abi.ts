...
export const observerAbi = parseAbi([
  ...
  "event JoinTollRefundScheduleUpdated(uint64 cutoff1,uint16 bps1,uint64 cutoff2,uint16 bps2,uint64 cutoff3,uint16 bps3,uint16 bps4)",
  ...
  "event ChannelExitTollBurned(address indexed user,uint256 indexed channelId,uint256 amount,address indexed burnAddress)",
  "event ChannelOperationAbandoned(uint256 indexed channelId,address indexed leader,uint64 abandonedAt)",
...
const eventGroups: Record<string, string> = {
  ...
  JoinTollRefundScheduleUpdated: "policy",
  ...
  ChannelExitTollBurned: "withdrawal",
  ChannelOperationAbandoned: "policy",
